    ...
    if (err) {
        ...
        setInterval(function() {
            var options = {
                ...
                path: "/api/v1/devices/4/variables/465/data",
                method: "GET"
            };
            ...
            var req = http.request(options, function(res) {
                ...
                res.on('end', function() {
                    ...
                    deviceData.description = "Active Energy imp";
                    deviceData.dataType = "Numeric";
                    deviceData.engUnit = "kWh";
                    ...
                    deviceData.decodedValue = "Acceso";
